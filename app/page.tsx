...
export default function Home() {
    ...
    return (
            ...
            <main className="flex flex-col gap-12 max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <Section title="Language">
                        <Item
                            ...
                            color="purple"
                        >
                            <p className="md:hidden block  ">Score: 160(AL)</p>
                        </Item>
                        <Item
                            title="TOEIC"
                            subtitle="ETS"
                            ...
                            color="purple"
                        >
                            <p className="md:hidden block ">Score: 875/990</p>
                        </Item>
                ...
                <Section title="Career">
                    <Item
                        ...
                        rightContent={{
                            top: "Goksung, South Korea",
                            bottom: "2026.01 ~ Present"
                        }}
                        color="green"
                        imageList={[
        ...
        SCADA 시스템과 연동하여 실시간 생산 데이터를 수집하고 분석합니다.`,
            ...
            color="red"
          >
            <p className="md:block hidden text-gray-700 dark:gray-300 mt-2">Custom dataset annotation 검수툴</p>
                ...
                <Section title="Awards">
                    ...
                    >
                        <p className="md:block hidden  mt-2">Eye-Tracking Automated Korean Language Question Program Using Furiosa AI NPU, &ldquo;Eying&rdquo;</p>
                    </Item>
                    <Item
                    ...
                    >
                        <p className="md:block hidden  mt-2"></p>
                    </Item>
                </Section>
